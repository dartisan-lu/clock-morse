        ...
        function (CanvasKitInit) {
                ...
                a.Vd.push(function () {
                    ...
                    a.MakeSurface = function (b, d) {
                        ...
                        if (f = a.Surface._makeRasterDirect(f,
                            m, 4 * b)) f.Nd = null, f.Ef = b, f.Af = d, f.Cf = h, f.$e = m, f.getCanvas().clear(a.TRANSPARENT);
                        return f
                    };
            ...
            (function (a) {
                ...
                a.Vd.push(function () {
                    ...
                    a.MakeOnScreenGLSurface = function (n, q, v, D) {
                        ...
                        q = this._MakeOnScreenGLSurface(n,
                            q, v, D);
                        if (!q) return null;
                        q.Md = n.Md;
                        return q
                    ...
                    a.MakeWebGLCanvasSurface = function (n, q, v) {
                        q = q || null;
                        var D = n, I = "undefined" !== typeof OffscreenCanvas && D instanceof OffscreenCanvas;
                        if (!("undefined" !==
                            typeof HTMLCanvasElement && D instanceof HTMLCanvasElement || I || (D = document.getElementById(n), D))) throw"Canvas with id " + n + " was not found";
                    ...
                    a.Surface.prototype.makeImageFromTextureSource = function (n, q, v) {
                        ...
                        2 === x.version ? D.texImage2D(D.TEXTURE_2D, 0, D.RGBA, q.width, q.height, 0, D.RGBA, D.UNSIGNED_BYTE, n) : D.texImage2D(D.TEXTURE_2D, 0, D.RGBA,
                            D.RGBA, D.UNSIGNED_BYTE, n);
                        u(D, q);
                    ...
                    a.Surface.prototype.updateTextureFromSource = function (n, q, v) {
                        if (n.Le) {
                            a.Od(this.Md);
                            var D = n.getImageInfo(), I = x.ge, M = m(I, ha[n.Le], D, v);
                            2 === x.version ? I.texImage2D(I.TEXTURE_2D, 0, I.RGBA, h(q), f(q), 0, I.RGBA, I.UNSIGNED_BYTE, q) : I.texImage2D(I.TEXTURE_2D, 0, I.RGBA, I.RGBA, I.UNSIGNED_BYTE, q);
                            u(I, D, v);
                            this._resetContext();
                            ha[n.Le] = null;
                            n.Le = d(M);
                    ...
                    a.MakeLazyImageFromTextureSource = function (n, q, v) {
                        ...
                        var D = {
                            makeTexture: function () {
                                var I = x, M = I.ge, z = m(M, M.createTexture(), q, v);
                                2 === I.version ? M.texImage2D(M.TEXTURE_2D, 0, M.RGBA, q.width, q.height, 0, M.RGBA, M.UNSIGNED_BYTE, n) : M.texImage2D(M.TEXTURE_2D, 0, M.RGBA,
                                    M.RGBA, M.UNSIGNED_BYTE, n);
                                u(M, q, v);
                                return d(z)
                            }, freeSrc: function () {
                            }
            ...
            (function (a) {
                ...
                function D(e) {
                    ...
                    if (e instanceof Float32Array) c.ce = v(e, "HEAPF32"), c.count = e.length / 4; else if (e instanceof Uint32Array) c.ce = v(e, "HEAPU32"), c.colorType = a.ColorType.RGBA_8888; else if (e instanceof Array) {
                        if (e && e.length) {
                ...
                a.Malloc = function (e, c) {
                    ...
                    return {
                        _ck: !0, length: c, byteOffset: g, re: null, subarray: function (l, r) {
                ...
                a.onRuntimeInitialized = function () {
                    ...
                    a.Shader.MakeSweepGradient = function (c, g, l, r, y, C, J, Q, O, W) {
                        ...
                        O = O || 360;
                        C = I(C);
                        c = a.Shader._MakeSweepGradient(c, g, t.ce, t.colorType,
                ...
                a.M44.invert = function (e) {
                    var c = e[0], g = e[4], l = e[8], r = e[12], y = e[1], C = e[5], J = e[9], Q = e[13], O = e[2],
                        W = e[6], t = e[10], F = e[14], P = e[3], X = e[7], ia = e[11];
                    e = e[15];
                    var la = c * C - g * y, qa = c * J -
                            l * y, sa = c * Q - r * y, ba = g * J - l * C, H = g * Q - r * C, k = l * Q - r * J,
                        p = O * X - W * P, A = O * ia - t * P, B = O * e - F * P, E = W * ia - t * X, G = W * e - F * X,
                        L = t * e - F * ia, ca = la * L - qa * G + sa * E + ba * B - H * A + k * p, da = 1 / ca;
                    ...
                    G *= da;
                    L *= da;
                    c = [C * L - J * G + Q * E, J * B - y * L - Q * A, y * G - C * B + Q * p, C * A - y * E - J * p, l * G - g * L - r * E, c * L - l * B + r * A, g * B - c * G - r * p, c * E - g * A + l * p, X * k - ia * H + e * ba, ia * sa - P * k - e * qa, P * H - X * sa + e * la, X * qa - P * ba - ia * la, t * H - W * k - F * ba, O * k - t * sa + F * qa, W * sa - O * H - F * la, O * ba - W * qa + t * la];
                ...
                (function (e) {
                    ...
                    e.Vd.push(function () {
                        ...
                        e.ParagraphBuilder.prototype.buildWithClientInfo = function (t, F, P, X) {
                            var ia = v(t, "HEAPU32"), la = v(F, "HEAPU32"), qa = v(P, "HEAPU32"), sa = v(X, "HEAPU32"),
                                ba =
                                    this._buildWithClientInfo(ia, t && t.length || 0, la, F && F.length || 0, qa, P && P.length || 0, sa, X && X.length || 0);
                            q(ia, t);
                            q(la, F);
                            q(qa, P);
                            q(sa, X);
                ...
                (function () {
                    ...
                    function r(H) {
                        ...
                        Object.defineProperty(this, "currentTransform", {
                            enumerable: !0, get: function () {
                                return {
                                    a: this.Ud[0], c: this.Ud[1],
                                    e: this.Ud[2], b: this.Ud[3], d: this.Ud[4], f: this.Ud[5]
                                }
                            }, set: function (k) {
                        ...
                        Object.defineProperty(this, "font", {
                            enumerable: !0, get: function () {
                                ...
                                p.typeface = ba[A] ? ba[A][(p.style || "normal") + "|" + (p.variant || "normal") + "|" + (p.weight || "normal")] ||
                                    ba[A]["*"] : null;
                        ...
                        this.fill = function (k, p) {
                            "string" === typeof k ? (p = k, k = this.Sd) : k && k.Ze && (k = k.Wd);
                            if ("evenodd" === p) this.Sd.setFillType(a.FillType.EvenOdd); else {
                                if ("nonzero" !==
                        ...
                        this.isPointInPath = function (k, p, A) {
                            var B = arguments;
                            if (3 === B.length) var E = this.Sd; else if (4 === B.length) E = B[0], k = B[1], p = B[2], A = B[3]; else throw"invalid arg count, need 3 or 4, got " + B.length;
                        ...
                        this.isPointInStroke = function (k, p) {
                            var A = arguments;
                            if (2 === A.length) var B =
                                this.Sd; else if (3 === A.length) B = A[0], k = A[1], p = A[2]; else throw"invalid arg count, need 2 or 3, got " + A.length;
                            if (!isFinite(k) || !isFinite(p)) return !1;
                            A = this.nf([k, p]);
                            k = A[0];
                            p = A[1];
                        ...
                        this.putImageData = function (k, p, A, B, E, G, L) {
                            if (e([p, A, B, E, G, L])) if (void 0 === B) this.Nd.writePixels(k.data, k.width, k.height, p, A); else if (B = B || 0, E = E || 0, G = G || k.width, L = L || k.height, 0 > G && (B += G, G = Math.abs(G)), 0 > L && (E += L, L = Math.abs(L)), 0 > B && (G += B, B = 0), 0 > E && (L += E, E = 0), !(0 >= G || 0 >= L)) {
                                k = a.MakeImage({
                                        width: k.width,
                                        height: k.height,
                                        alphaType: a.AlphaType.Unpremul,
                        ...
                        this.af = function () {
                            ...
                            if (this.ve.length) {
                                var A =
                                    a.PathEffect.MakeDash(this.ve, this.Ie);
                                k.setPathEffect(A)
                            }
                            k.dispose = function () {
                                A && A.delete();
                        ...
                        this.strokeRect = function (k, p, A, B) {
                            var E = this.af(), G = this.ze(E);
                            G && (this.Nd.save(), this.se(), this.Nd.drawRect(a.XYWHRect(k, p, A, B), G), this.Nd.restore(), G.dispose());
                            this.Nd.drawRect(a.XYWHRect(k, p, A,
                                B), E);
                            E.dispose()
                        };
                            ...
                            if (A) {
                                ...
                                if (p = A.encodeToBytes(B, p || .92)) {
                                    ...
                                    if ("undefined" !== typeof Buffer) p = Buffer.from(p).toString("base64"); else {
                                        A = 0;
                                        B = p.length;
                                        for (var E = "", G; A < B;) G = p.slice(A, Math.min(A + 32768, B)), E += String.fromCharCode.apply(null, G), A += 32768;
                                        p = btoa(E)
                                    }
                                    return k + p
                                }
                    ...
                    function F(H, k, p, A, B, E, G, L, ca) {
                        if (e([k, p, A, B, E, G, L])) {
                            ...
                            var da = 2 * Math.PI, Ia = G % da;
                            0 > Ia && (Ia += da);
                            var bb = Ia - G;
                            G = Ia;
                            L += bb;
                            !ca && L - G >= da ? L = G + da : ca && G - L >= da ? L = G - da : !ca && G > L ? L = G + (da - (G - L) % da) : ca && G < L && (L = G - (da - (L - G) % da));
                            E ? (ca = a.Matrix.rotated(E, k, p), E = a.Matrix.rotated(-E, k, p), H.transform(E), t(H, k, p, A, B, G, L), H.transform(ca)) : t(H, k, p, A, B, G, L)
                        }
                    }
                    ...
                    a.ImageData = function () {
                        ...
                        if (3 === arguments.length) {
                            ...
                            if (p %
                                H) throw"bytes must divide evenly by width";
            ...
            function pc(a, b, d) {
                if (void 0 === a[b].Zd) {
                    var f = a[b];
                    a[b] = function () {
                        a[b].Zd.hasOwnProperty(arguments.length) || Y("Function '" + d + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + a[b].Zd + ")!");
            ...
            function qc(a, b, d) {
                w.hasOwnProperty(a) ? ((void 0 === d || void 0 !== w[a].Zd && void 0 !== w[a].Zd[d]) && Y("Cannot register public name '" + a + "' twice"), pc(w, a, a), w.hasOwnProperty(d) && Y("Cannot register multiple overloads of a function with the same number of arguments (" + d + ")!"), w[a].Zd[d] = b) : (w[a] = b, void 0 !== d && (w[a].tg = d))
            }
            ...
            function sc(a, b, d) {
                for (; b !== d;) b.Oe || Y("Expected null or instance of " + d.name + ", got an instance of " + b.name), a = b.Oe(a), b = b.ie;
                return a
            }
            ...
            function vc(a, b) {
                ...
                b.Ld || Y('Cannot pass "' + uc(b) + '" as a ' + this.name);
                b.Ld.Td || Y("Cannot pass deleted object as a pointer of type " + this.name);
                !this.Se && b.Ld.Xd.Se && Y("Cannot convert argument of type " + (b.Ld.fe ? b.Ld.fe.name : b.Ld.Xd.name) + " to parameter type " + this.name);
                d = sc(b.Ld.Td, b.Ld.Xd.Rd, this.Rd);
                if (this.Te) switch (void 0 === b.Ld.$d && Y("Passing raw pointer to smart pointer is illegal"),
                    this.hg) {
                    case 0:
                        b.Ld.fe === this ? d = b.Ld.$d : Y("Cannot convert argument of type " + (b.Ld.fe ? b.Ld.fe.name : b.Ld.Xd.name) + " to parameter type " + this.name);
                        break;
                    case 1:
                        d = b.Ld.$d;
                        break;
                    case 2:
                        if (b.Ld.fe === this) d = b.Ld.$d; else {
                            var f = b.clone();
                            d = this.cg(d, wc(function () {
                                f["delete"]()
                            }));
                            null !== a && a.push(this.le, d)
                        }
            ...
            function Nc(a, b, d, f, h) {
                ...
                for (d = 1; d < b.length; ++d) if (null !== b[d] && void 0 === b[d].ee) {
                    n = !0;
                    break
                }
                var q = "void" !== b[0].name, v = m - 2, D = Array(v), I = [], M = [];
                return function () {
                    ...
                    for (var N = 0; N < v; ++N) D[N] =
                        b[N + 2].toWireType(M, arguments[N]), I.push(D[N]);
                    N = f.apply(null, I);
                    if (n) Fb(M); else for (var T = u ? 1 : 2; T < b.length; T++) {
                        var U = 1 === T ? z : D[T - 2];
            ...
            var kd = 1, ld = [], md = [], nd = [], od = [], ha = [], pd = [], qd = [], na = [], rd = [], sd = [],
                td = {}, ud = {}, vd = 4;
            ...
            function Ad(a, b) {
                var d = fa(na), f = {Uf: d, attributes: b, version: b.majorVersion, ge: a};
            ...
            function Ud(a, b, d, f) {
                ...
                v = {
                    ...
                    "%n": function () {
                        ...
                        if (N) 53 == N && (T = (z.je + 371 - z.pe) % 7, 4 == T || 3 == T && Rd(z.qe) || (N = 1)); else {
                            N = 52;
            ...
            oc.prototype.clone = function () {
                ...
                var a = nc, b = Object, d = b.create, f = Object.getPrototypeOf(this), h = this.Ld;
                a = a(d.call(b, f, {
                    Ld: {
                        value: {
                            count: h.count,
            ...
            yc.prototype.fromWireType = function (a) {
                function b() {
                    return this.Te ? mc(this.Rd.Ge, {Xd: this.ag, Td: d, fe: this, $d: a}) : mc(this.Rd.Ge, {
                        Xd: this,
                        Td: a
                    })
                }
                ...
                return null === h ? b.call(this) : this.Te ? mc(f.Rd.Ge, {Xd: f, Td: h, fe: this, $d: a}) : mc(f.Rd.Ge,
                    {Xd: f, Td: h})
            };
            ...
            var pe = {
                ...
                D: function (a) {
                    ...
                    Pb([a], m, u => {
                        var n = {};
                        h.forEach((q, v) => {
                            var D = u[v], I = q.Rf, M = q.Sf, z = u[v + h.length], N = q.eg, T = q.gg;
                            n[q.Lf] = {
                                read: U => D.fromWireType(I(M, U)), write: (U, ra) => {
                                    var va = [];
                        ...
                        return [{
                            name: b.name, fromWireType: function (q) {
                                ...
                                null !== q && q.push(f, I);
                                return I
                            }, argPackAdvance: 8, readValueFromPointer: Gb, ee: f
                        }]
                    })
                },
                qb: function () {
                ...
                o: function (a, b, d, f, h, m, u, n, q, v, D, I, M) {
                    ...
                    Pb([a, b, d], f ? [f] : [], function (N) {
                        ...
                        N = Lb(z, function () {
                            ...
                            if (void 0 === va.oe) throw new ac(D +
                                " has no accessible constructor");
                            var hb = va.oe[arguments.length];
                            if (void 0 === hb) throw new ac("Tried to invoke ctor of " + D + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(va.oe).toString() + ") parameters instead!");
                ...
                z: function (a, b, d, f, h, m) {
                    ...
                    Pb([], [a], function (n) {
                        ...
                        if (void 0 !== n.Rd.oe[b - 1]) throw new ac("Cannot register multiple constructors with identical number of parameters (" + (b - 1) + ") for class '" + n.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
                        n.Rd.oe[b - 1] = () => {
                ...
                b: function (a, b, d, f, h, m, u, n) {
                    ...
                    Pb([], [a], function (v) {
                        ...
                        n && v.Rd.bg.push(b);
                        var M = v.Rd.Ge, z = M[b];
                        void 0 === z || void 0 === z.Zd && z.className !== v.name && z.De === d - 2 ? (D.De = d - 2, D.className = v.name, M[b] = D) : (pc(M, b, I), M[b].Zd[d - 2] = D);
                        Pb([], q, function (N) {
                            N = Nc(I, N, v, m, u);
                ...
                Gb: function (a, b) {
                    ...
                    Qb(a, {
                        name: b, fromWireType: function (d) {
                            ...
                            return wc(f)
                        }, argPackAdvance: 8, readValueFromPointer: Gb, ee: null
                    })
                },
                n: function (a, b, d, f) {
                    function h() {
                    ...
                    Qb(a, {
                        name: b, constructor: h, fromWireType: function (m) {
                            ...
                            return u.value
                        }, argPackAdvance: 8, readValueFromPointer: Tc(b, d, f), ee: null
                    });
                    qc(b, h)
                },
                e: function (a, b, d) {
                ...
                Y: function (a, b, d) {
                    ...
                    Qb(a, {
                        name: b, fromWireType: function (f) {
                            ...
                            return h
                        }, argPackAdvance: 8, readValueFromPointer: Vc(b, d), ee: null
                    })
                },
                ...
                X: function (a, b) {
                    ...
                    Qb(a, {
                        name: b, fromWireType: function (f) {
                            ...
                            lb[n >> 2] = u;
                            if (d && m) pa(h, K, q, u + 1); else if (m) for (m = 0; m < u; ++m) {
                            ...
                            null !== f && f.push(Lc, n);
                            return n
                        }, argPackAdvance: 8, readValueFromPointer: Gb, ee: function (f) {
                            Lc(f)
                        }
                    })
                },
                    ...
                    Qb(a, {
                        name: d, fromWireType: function (q) {
                            for (var v = lb[q >> 2], D = u(), I, M = q + 4, z = 0; z <= v; ++z) {
                                var N = q + 4 + z * b;
                                if (z == v || 0 == D[N >> n]) M = f(M, N - M), void 0 === I ? I = M : (I += String.fromCharCode(0), I +=
                                    M), M = N + b
                            }
                            Lc(q);
                            return I
                            ...
                            var D = m(v), I = Gd(4 + D + b);
                            lb[I >> 2] = D >> n;
                            h(v, I + 4, D + b);
                            null !== q && q.push(Lc, I);
                            return I
                        }, argPackAdvance: 8, readValueFromPointer: Gb, ee: function (q) {
                            Lc(q)
                        }
                    })
                },
                ...
                ma: function (a, b, d, f, h, m, u, n) {
                    2 <=
                    x.version ? Z.Ee || !u ? Z.compressedTexImage2D(a, b, d, f, h, m, u, n) : Z.compressedTexImage2D(a, b, d, f, h, m, K, n, u) : Z.compressedTexImage2D(a, b, d, f, h, m, n ? K.subarray(n, n + u) : null)
                },
                na: function (a, b, d, f, h, m, u, n, q) {
                    2 <= x.version ? Z.Ee || !n ? Z.compressedTexSubImage2D(a, b, d, f, h, m, u, n, q) : Z.compressedTexSubImage2D(a, b, d, f, h, m, u, K, q, n) : Z.compressedTexSubImage2D(a, b, d, f, h, m, u, q ? K.subarray(q, q + n) : null)
                },
                ...
                Ma: function (a, b, d) {
                    ...
                    b) a = Z.getProgramInfoLog(a), null === a && (a = "(unknown error)"), R[d >> 2] = a.length + 1; else if (35719 == b) {
                        if (!a.We) for (b = 0; b < Z.getProgramParameter(a, 35718); ++b) a.We = Math.max(a.We, Z.getActiveUniform(a, b).name.length + 1);
                        R[d >> 2] = a.We
                    } else if (35722 == b) {
                        if (!a.Ue) for (b = 0; b < Z.getProgramParameter(a, 35721); ++b) a.Ue = Math.max(a.Ue, Z.getActiveAttrib(a, b).name.length + 1);
                        R[d >> 2] = a.Ue
                    } else if (35381 == b) {
                        if (!a.Ve) for (b = 0; b < Z.getProgramParameter(a, 35382); ++b) a.Ve = Math.max(a.Ve, Z.getActiveUniformBlockName(a, b).length + 1);
                        R[d >>
                        2] = a.Ve
                ...
                Pa: function (a, b) {
                    ...
                    if (a = md[a]) {
                        var d = a, f = d.Ne,
                            h = d.xf, m;
                        if (!f) for (d.Ne = f = {}, d.wf = {}, m = 0; m < Z.getProgramParameter(d, 35718); ++m) {
                ...
                sc: function (a, b, d, f, h, m, u, n) {
                    Z.uf.multiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(a, R, b >> 2, d, R, f >> 2,
                ...
                Ua: function (a, b, d, f, h, m, u) {
                    if (2 <= x.version) if (Z.cf) Z.readPixels(a, b, d, f, h, m, u); else {
                        var n = Id(m);
                ...
                bb: function (a, b, d, f, h, m, u, n, q) {
                    if (2 <= x.version) if (Z.Ee) Z.texImage2D(a, b, d, f, h, m, u, n, q); else if (q) {
                        var v = Id(n);
                ...
                gb: function (a, b, d, f, h, m, u, n, q) {
                    if (2 <= x.version) if (Z.Ee) Z.texSubImage2D(a, b, d, f, h, m, u, n, q); else if (q) {
                        var v = Id(n);
