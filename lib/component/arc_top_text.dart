...
class ArcTopText extends PositionComponent {
  late String text;
  ...
  ArcTopText(this.text, this.radius, this.textRadius, this.textSize, {Vector2? position}) : super(position: position) {
  ...
  void render(
    ...
    for (int i = 0; i < text.length; ++i) {
      final double angle = 4.85 + (i * 0.25) - (text.length / 2 * 0.25);
